# Grille d’évaluation – TP Docker & Compose

**Travail en binôme**

Doit être rendu sous la forme d’un **repository accompagné d’un README structuré**.
...
| Stabilité du projet              | Le projet fonctionne de manière reproductible sans manipulation manuelle imprévue                        |
...
| Observations et preuves           | Captures d’écran, logs ou observations permettant de comprendre ce qui a été testé |
...
| Situation                             | Pénalité |
| ------------------------------------- | -------- |
| Projet impossible à lancer            | -20      |
| README absent ou incomplet            | -15      |
| Travail manifestement non fonctionnel | -20      |
